if(NOT CMAKE_TOOLCHAIN_FILE)
  message(FATAL_ERROR "CMAKE_TOOLCHAIN_FILE required for tvos. See ${CMAKE_SOURCE_DIR}/cmake/README.md")
endif()

set(CORE_MAIN_SOURCE ${CMAKE_SOURCE_DIR}/xbmc/platform/darwin/tvos/XBMCApplication.mm)

set(ARCH_DEFINES -D_LINUX -DTARGET_POSIX -DTARGET_DARWIN -DTARGET_DARWIN_TVOS)
...
set(CMAKE_XCODE_ATTRIBUTE_APPLETVOS_DEPLOYMENT_TARGET "10.2")
...
# Unify output directories for tvOS packaging scripts
