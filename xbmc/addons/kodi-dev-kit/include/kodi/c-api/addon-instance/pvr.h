...
extern "C"
{
  ...
  typedef struct KodiToAddonFuncTable_PVR
  {
    ...
    //--==----==----==----==----==----==----==----==----==----==----==----==----==
    // Channel provider interface functions
    ...
    //--==----==----==----==----==----==----==----==----==----==----==----==----==
    // Recording interface functions
    enum PVR_ERROR(__cdecl* GetMediaAmount)(const struct AddonInstance_PVR*, bool, int*);
    enum PVR_ERROR(__cdecl* GetMedia)(const struct AddonInstance_PVR*, ADDON_HANDLE, bool);
    enum PVR_ERROR(__cdecl* DeleteMediaTag)(const struct AddonInstance_PVR*,
                                            const struct PVR_MEDIA_TAG*);
    enum PVR_ERROR(__cdecl* UndeleteMediaTag)(const struct AddonInstance_PVR*,
                                              const struct PVR_MEDIA_TAG*);
    enum PVR_ERROR(__cdecl* DeleteAllMediaFromTrash)(const struct AddonInstance_PVR*);
    enum PVR_ERROR(__cdecl* RenameMediaTag)(const struct AddonInstance_PVR*,
                                            const struct PVR_MEDIA_TAG*);
    enum PVR_ERROR(__cdecl* SetMediaTagLifetime)(const struct AddonInstance_PVR*,
                                                 const struct PVR_MEDIA_TAG*);
