...
public:
  ...
  void SetModificationTime(time_t modificationTime) { m_cStructure->modificationTime = modificationTime; }
  ...
  inline bool StatFile(const std::string& filename, kodi::vfs::FileStatus& buffer)
  {
    ...
    return CAddonBase::m_interface->toKodi->kodi_filesystem->stat_file(CAddonBase::m_interface->toKodi->kodiBase,
                                                                       filename.c_str(),
                                                                       buffer);
  }
  //----------------------------------------------------------------------------
