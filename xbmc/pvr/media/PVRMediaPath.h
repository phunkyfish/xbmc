...
public:
  ...
  static const std::string PATH_ACTIVE_TV_MEDIA;
  static const std::string PATH_ACTIVE_RADIO_MEDIA;
  static const std::string PATH_DELETED_TV_MEDIA;
  static const std::string PATH_DELETED_RADIO_MEDIA;

  explicit CPVRMediaPath(const std::string& strPath);
  CPVRMediaPath(bool bDeleted, bool bRadio);
  CPVRMediaPath(bool bDeleted,
                bool bRadio,
