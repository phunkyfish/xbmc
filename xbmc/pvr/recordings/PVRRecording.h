...
namespace PVR
{
  ...
  public:
   ...
   /*!
    * @brief Get the client provider name for this recordings
    * @return m_strProviderName The name for this media tags provider
    */
   std::string ProviderName() const;

   /*!
    * @brief Get the default provider of this recordings The default
    *        provider represents the PVR add-on itself.
    * @return The default provider of this recordings
    */
   std::shared_ptr<CPVRProvider> GetDefaultProvider() const;

   /*!
    * @brief Whether or not this recordings has provider set by the client.
    ...
    * @return The provider of this recordings
    */
  ...
  private:
    ...
    bool m_bDirty = false;
    int m_iClientProviderUniqueId; /*!< provider uid associated with this recordings on the client */
